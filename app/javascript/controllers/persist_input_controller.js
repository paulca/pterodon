...
export default class extends Controller {
  ...
  connect() {
    this.storageKey = this.keyValue || `persist_input_${this.textareaTarget.name || this.textareaTarget.id || 'default'}`
    this.restoreValue()
  ...
  disconnect() {
    ...
    this.textareaTarget.removeEventListener('change', this.saveValue.bind(this))
